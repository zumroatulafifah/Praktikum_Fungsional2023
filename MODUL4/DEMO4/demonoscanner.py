...
# # List transformasi
# func_list = [translate, rotate, scale]

# # Transformasi gabungan
# A_transformed = combined_transform(func_list)(A)

# # Menentukan persamaan garis setelah transformasi
# equation_transformed = line_equation_of(A_transformed, M)

# print("Persamaan garis yang melalui titik (0,9) dan bergradien 0:")
...
# A_transformed = translate(rotate(scale(A)))
# Menggunakan decorator pada titik A
